...
@Mapper(componentModel = "spring",
        ...
        imports = io.github.j_yuhanwang.food_ordering_app.enums.PaymentStatus.class
)
public interface PaymentMapper {
    ...
    @Mapping(target="isSuccess",expression = "java(entity.getPaymentStatus()==PaymentStatus.COMPLETED)")
